...
if ($messagePayload != null) {
  if ($messagePayload == "สมัครสมาชิก") {
    ...
    $jsonData = '{
      ...
      "text":
        "
          ท่านสามารถเลือกหัวข้อที่ต้องการสอบถามได้
          
          หัวข้อที่ 1 โปรโมชั่น
          หัวข้อที่ 2 กลุ่มสูตร
          หัวข้อที่ 3 เว็บไซต์
          หัวข้อที่ 4 สอบถามเพิ่มเติม
          หัวข้อที่ 5 แจ้งปัญหา

          โดยการเลือกหัวข้อที่ต้องการในแถบเมนูข้างล่าง
        "
      }
    }';
  } else {
