...
if ($message != null) {
  if ($message == "เมนูหลัก") {
    ...
    $jsonData = '{
      ...
      "message": {
        "text":"ท่านสามารถเลือกหัวข้อที่ต้องการจะสอบถามได้ โดยมีหัวข้อดังนี้ \r\n \r\nหัวข้อที่ 1 สูตรโกงบาคาร่า \r\nหัวข้อที่ 2 กลุ่ใวิเคราะห์บอล \r\nหัวข้อที่ 3 กลุ่มนำเล่นบาคาร่า \r\nหัวข้อที่ 4 วิธีเข้าเล่นบาคาร่า \r\nหัวข้อที่ 5 วิธีการเข้าแทงบอล \r\n \r\nเลือกตัวข้อโดยการคลิกที่แถบเมนูด้านล่าง",
        "quick_replies":[
          {
            "content_type":"text",
            "title":"กลุ่ม/สูตร : หัวข้อ 1",
            "payload":"กลุ่ม/สูตร : หัวข้อ 1",
          },
          {
            "content_type":"text",
            "title":"กลุ่ม/สูตร : หัวข้อ 2",
            "payload":"กลุ่ม/สูตร : หัวข้อ 2",
          },
          {
            "content_type":"text",
            "title":"กลุ่ม/สูตร : หัวข้อ 3",
            "payload":"กลุ่ม/สูตร : หัวข้อ 3",
          },
          {
            "content_type":"text",
            "title":"กลุ่ม/สูตร : หัวข้อ 4",
            "payload":"กลุ่ม/สูตร : หัวข้อ 4",
          },
          {
            "content_type":"text",
            "title":"กลุ่ม/สูตร : หัวข้อ 5",
            "payload":"กลุ่ม/สูตร : หัวข้อ 5",
          },
          {
            "title":"ย้อนกลับสอบถาม",
            "content_type":"text",
